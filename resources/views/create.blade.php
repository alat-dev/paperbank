                    ...
                    <div class="mb-3">
                       ...
                       <div class="mb-3">
                        <div class="form-floating">
                            ...
                            <textarea class="form-control" name="description" placeholder="Leave a comment here" id="floatingTextarea" value={{ old('description') }}></textarea>
                       ...
                       <div class="mb-3">
                        ...
                        <input class="form-control @error('pdf-file') is-invalid @enderror" name="pdf_file" type="file" accept="application/pdf" id="formFile">
